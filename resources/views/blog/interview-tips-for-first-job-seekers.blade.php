...
<head>
    ...
    <title> Interview Tips for Job Seekers | Lan Pya</title>
...
<body class="font-sans leading-relaxed text-gray-200 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen flex flex-col items-center justify-center p-8">
    ...
    <div class="w-full max-w-6xl text-center">
        ...
        <div class="max-w-4xl mx-auto py-12 px-4 text-gray-300">
            <h1 class="text-4xl font-bold text-blue-400 mb-4">Interview Tips for First Job Seekers</h1>
            <p class="mb-6 text-lg">Nervous about your first job interview? Here are some tips to help you feel more confident:</p>

            <ol class="list-decimal list-inside mb-6 space-y-2">
                <li><strong>Research the company</strong> – Know what they do and their mission.</li>
                <li><strong>Practice common questions</strong> – Prepare answers to "Tell me about yourself" or "What are your strengths?"</li>
                <li><strong>Dress neatly</strong> – First impressions matter.</li>
                <li><strong>Arrive early</strong> – Show that you’re punctual and serious.</li>
                <li><strong>Be polite and thank them</strong> – A positive attitude goes a long way.</li>
            </ol>

            <p>Remember: It's okay to be nervous. Preparation and practice will help!</p>
