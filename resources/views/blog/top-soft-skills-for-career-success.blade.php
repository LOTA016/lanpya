...
<body class="font-sans leading-relaxed text-gray-200 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen flex flex-col items-center justify-center p-8">
    ...
    <div class="w-full max-w-6xl text-center">
        ...
        <div class="max-w-4xl mx-auto py-12 px-4 text-gray-300">
            <h1 class="text-4xl font-bold text-blue-400 mb-4">Top Soft Skills for Career Success</h1>
            <p class="mb-6 text-lg">Soft skills are just as important as technical abilities in the modern workplace. Here are key soft skills that can help Myanmar youth stand out:</p>

            <ul class="list-disc list-inside mb-6 space-y-2">
                <li><strong>Communication:</strong> Clearly express ideas and listen actively.</li>
                <li><strong>Teamwork:</strong> Collaborate effectively with others from diverse backgrounds.</li>
                <li><strong>Problem Solving:</strong> Think critically and find practical solutions.</li>
                <li><strong>Adaptability:</strong> Be flexible in a fast-changing world.</li>
                <li><strong>Time Management:</strong> Prioritize and meet deadlines.</li>
            </ul>

            <p>Improving these skills boosts employability and helps in every part of life.</p>
