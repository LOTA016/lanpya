<div class="p-6 lg:p-8 bg-gradient-to-r from-indigo-500 to-purple-500 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">

    <div class="animate__animated animate__fadeInUp animate__delay-0.5s">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-6 stroke-gray-400 mr-3">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" />
                </svg>
                <h2 class="text-xl font-semibold text-gray-900">
                    <a href="{{ route('career.form') }}" class="hover:underline">Career Pathway Test</a>
                </h2>
            </div>
    ...
    <div class="animate__animated animate__fadeInUp animate__delay-1s">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-6 stroke-gray-400 mr-3">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" />
                </svg>
                <h2 class="text-xl font-semibold text-gray-900">
                    <a href="{{ route('mentors.index') }}" class="hover:underline">Find Mentors</a>
                </h2>
            </div>
    ...
    <div class="animate__animated animate__fadeInUp animate__delay-1.5s">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-6 stroke-gray-400 mr-3">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" />
    ...
    <div class="animate__animated animate__fadeInUp animate__delay-2s">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center">
                ...
                <h2 class="text-xl font-semibold text-gray-900">
                    <a href="{{ route('welcome') }}" class="hover:underline">Podcasts</a>
                </h2>
            </div>
